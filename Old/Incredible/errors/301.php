...
<div id="top-bar">
    <div class="container-padding cf">
    	<!-- Nav -->
        <div class="fl white-text big bold">O site mudou de host!</div>
        
        <div class="fr white-text big">Sorry about that (Error 301)...</div>
    </div>
</div> <!-- End Top Bar -->
        ...
        <div id="main-content" class="fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-heading cf">
                    <h3 class="fl">Acesso proibido...</h3>
                ...
                <div class="content-module-main">
                	<h2>O nosso site mudou de host!<br /><br />Carregue no link abaixo para ser redirecionado para o novo site.<br />Não se preocupe pois tudo será mantido como estava!</h2>
                    <div class="stripe-separator"></div>
                    <div class="center"><a href="http://incredible.ihostwell.com"><img src="/img/logo/logo-big.png" /></a></div>
                </div><!-- End Module Main -->
            </div><!-- End Module -->
