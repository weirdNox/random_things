...
<div id="top-bar">
    <div class="container-padding cf">
    	<!-- Nav -->
        <div class="fl white-text big bold">A Incredible Community encontrou um erro....</div>
        
        <div class="fr white-text big">Sorry about that (Error 500)...</div>
    </div>
</div> <!-- End Top Bar -->
...
<div id="header">
        <div class="container-padding cf">
            <a href="../index.php"><img src="/img/logo/logo.png" alt="Incredible Community Logo" id="logo" class="fr" /></a>
        </div>
    </div> <!-- End header -->
        ...
        <div id="main-content" class="fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-main">
					<h2>O site encontrou um erro por isso foi redirecionado para aqui...<br />
                        <?php
                        if($_GET && !empty($_GET['error'])) {
                            echo '<b>Descrição do erro</b> - '.stripslashes($_GET['error']);
                        } else {
                            echo 'Não sabemos qual foi o erro.';
                        }

                        ?><br /><br />Pedimos desculpa pelo incómodo e esperamos ser rápidos a resolver o problema.</h2>
                    
                    <div class="stripe-separator"></div>
                    <div class="center"><a href="/index.php"><img src="/img/logo/logo-big.png" /></a></div>
                </div><!-- End Module Main -->
            </div><!-- End Module -->
...
<!-- Footer -->
<div id="footer">
    <p class="text-upper small">&copy; Copyright 2012 <strong><a href="http://www.facebook.com/pages/Incredible-Community/328267827261868" class="dark-link">Incredible Community.</a></strong></p>
