...
<div id="top-bar">
    <div class="container-padding cf">
    	<!-- Nav -->
        <div class="fl white-text big bold">Manutenção</div>
        
        <div class="fr white-text big">Sorry about that (Error 302)...</div>
    </div>
</div> <!-- End Top Bar -->
        ...
        <div id="main-content" class="fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-main">
					<h2>O site está neste momento em manutenção...<br /><br />Pedimos desculpa pelo incómodo e esperamos ser rápidos a resolver o problema.</h2>
            ...
            <div class="content-module">
				<!-- Module Heading -->
                <div class="content-module-heading cf">
                    <h3 class="fl">Problemas encontrados</h3>
                    <span class="fr span-text">Clica para contrair</span>
                    <span class="fr expand-span span-text">Clica para expandir</span>
                </div><!-- End Module Heading -->
                ...
                <!-- Module Main -->
                <div class="content-module-main">
					<h2>Por favor, visite mais tarde, pois ainda não há nenhum problema registado.</h2>
                </div><!-- End Module Main -->
            </div><!-- End Module -->
