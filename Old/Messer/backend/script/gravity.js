...
var el = $("body");
el.css("userSelect", "none");
el.css("webkitUserSelect", "none");
...
el.children().css("height", "100%");
el.children().css("overflow", "hidden");
el = $("html");
el.css("height", "100%");
...
setTimeout(function(){
			...
			function getElementProperties( element ) {
				...
				} while ( element = element.offsetParent && element.style.positon != "absolute" && element.style.positon != "relative");
